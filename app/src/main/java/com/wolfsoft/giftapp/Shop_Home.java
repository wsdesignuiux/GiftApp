...
public class Shop_Home extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shop__home);
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(Shop_Home.this);
        ...
        shop_home_adapter = new Shop_Home_Adapter(Shop_Home.this,shop_home_modelArrayList);
        recyclerView.setAdapter(shop_home_adapter);

        recyclerView = findViewById(R.id.recyclerview4);
        RecyclerView.LayoutManager layoutManager1 = new LinearLayoutManager(Shop_Home.this);
        ...
        shop_home_adapter_1 = new Shop_Home_Adapter_1(Shop_Home.this,shop_home_model_1ArrayList);
